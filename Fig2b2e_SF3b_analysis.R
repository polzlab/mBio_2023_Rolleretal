...
#
data_fig2b <- read.csv("Fig2b2e_SF3b_Ecoli_1E3_Data_withMetadata.csv")
head(data_fig2b)
tail(data_fig2b)
#
#
#split dataset by replicate
data_fig2b_rep1 <- subset(data_fig2b, data_fig2b$rep == "rep1")
data_fig2b_rep2 <- subset(data_fig2b, data_fig2b$rep == "rep2")
#
#
#calculate mean and median buoyant mass by well for each replicate
#rep1
rep1_groupmean <- tapply(data_fig2b_rep1$Mass, data_fig2b_rep1$SampleTime, mean)
rep1_groupmedian <- tapply(data_fig2b_rep1$Mass, data_fig2b_rep1$SampleTime, median)
rep1_groupIQR <- tapply(data_fig2b_rep1$Mass, data_fig2b_rep1$SampleTime, IQR)
rep1_group_Time_min <- sort(unique(data_fig2b_rep1$SampleTime))
...
rep1_stats$rep <- rep(1, 12)
#
rep1_stats
#
#rep2
rep2_groupmean <- tapply(data_fig2b_rep2$Mass, data_fig2b_rep2$SampleTime, mean)
rep2_groupmedian <- tapply(data_fig2b_rep2$Mass, data_fig2b_rep2$SampleTime, median)
rep2_groupIQR <- tapply(data_fig2b_rep2$Mass, data_fig2b_rep2$SampleTime, IQR)
rep2_group_Time_min <- sort(unique(data_fig2b_rep2$SampleTime))
#make a new dataframe of statistics
