...
data_fig1a_rep1 <- subset(data_fig1a, data_fig1a$rep == "rep1")
data_fig1a_rep2 <- subset(data_fig1a, data_fig1a$rep == "rep2")
#
#
#calculate mean and median buoyant mass by well for each replicate
#rep1
rep1_groupmean <- tapply(data_fig1a_rep1$Mass, data_fig1a_rep1$SampleTime, mean)
rep1_groupmedian <- tapply(data_fig1a_rep1$Mass, data_fig1a_rep1$SampleTime, median)
rep1_groupq1 <- tapply(data_fig1a_rep1$Mass, data_fig1a_rep1$SampleTime, quantile , 0.25, na.rm = T)
rep1_groupq3 <- tapply(data_fig1a_rep1$Mass, data_fig1a_rep1$SampleTime, quantile , 0.75, na.rm = T)
rep1_groupIQR <- tapply(data_fig1a_rep1$Mass, data_fig1a_rep1$SampleTime, IQR)
rep1_group_Time_min <- sort(unique(data_fig1a_rep1$SampleTime))
...
#
#rep2
rep2_groupmean <- tapply(data_fig1a_rep2$Mass, data_fig1a_rep2$SampleTime, mean)
rep2_groupmedian <- tapply(data_fig1a_rep2$Mass, data_fig1a_rep2$SampleTime, median)
rep2_groupq1 <- tapply(data_fig1a_rep2$Mass, data_fig1a_rep2$SampleTime, quantile , 0.25, na.rm = T)
rep2_groupq3 <- tapply(data_fig1a_rep2$Mass, data_fig1a_rep2$SampleTime, quantile , 0.75, na.rm = T)
rep2_groupIQR <- tapply(data_fig1a_rep2$Mass, data_fig1a_rep2$SampleTime, IQR)
rep2_group_Time_min <- sort(unique(data_fig1a_rep2$SampleTime))
#make a new dataframe of statistics
