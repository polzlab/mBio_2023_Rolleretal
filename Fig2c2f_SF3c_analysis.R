...
#
data_fig2c <- read.csv("Fig2c2f_SF3c_Ecoli_1E2_Data_withMetadata.csv")
head(data_fig2c)
tail(data_fig2c)
#
#
#split dataset by replicate
data_fig2c_rep1 <- subset(data_fig2c, data_fig2c$rep == "rep1")
data_fig2c_rep2 <- subset(data_fig2c, data_fig2c$rep == "rep2")
#
#
#calculate mean and median buoyant mass by well for each replicate
#rep1
rep1_groupmean <- tapply(data_fig2c_rep1$Mass, data_fig2c_rep1$SampleTime, mean)
rep1_groupmedian <- tapply(data_fig2c_rep1$Mass, data_fig2c_rep1$SampleTime, median)
rep1_groupIQR <- tapply(data_fig2c_rep1$Mass, data_fig2c_rep1$SampleTime, IQR)
rep1_group_Time_min <- sort(unique(data_fig2c_rep1$SampleTime))
...
#
#rep2
rep2_groupmean <- tapply(data_fig2c_rep2$Mass, data_fig2c_rep2$SampleTime, mean)
rep2_groupmedian <- tapply(data_fig2c_rep2$Mass, data_fig2c_rep2$SampleTime, median)
rep2_groupIQR <- tapply(data_fig2c_rep2$Mass, data_fig2c_rep2$SampleTime, IQR)
rep2_group_Time_min <- sort(unique(data_fig2c_rep2$SampleTime))
#make a new dataframe of statistics
