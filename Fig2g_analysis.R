...
#
#Load data
data_fig2g <- read.csv("/Volumes/rollerb21/Data/Manuscripts/SteadyStateMass/_publicdata/Figure2g/fig2g_withMetadata.csv", header = T)
data_fig2g
#
